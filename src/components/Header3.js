                ...
                <div className="row gx-5 align-items-center">
                    <div className="col-lg-4">
                        <div className="mb-5 mb-lg-0 text-left text-lg-left">
                            <h1 className="display-4 lh-1 mb-3">Submit a<br/><span className="primary">New Request</span></h1>
                            <h1 className="display-5 lh-1 mb-3">for you or for a <span className="primary">loved one</span></h1>
